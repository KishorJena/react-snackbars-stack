import { createTheme, ThemeProvider, Portal, Alert, Slide, Zoom, Fade, Grow } from '@mui/material';
import Snackbar from '@mui/material/Snackbar';
import React, { createContext, memo, useReducer, useRef, useEffect, useCallback, useMemo, useContext } from 'react';
...
var Provider = function Provider(_ref) {
  ...
  var instanceId = useRef(Date.now());
  useEffect(function () {
  ...
  var SnakbarTransition = useMemo(function () {
    return transitionComponents(transitionType, anchorOrigin);
  }, [transitionType, anchorOrigin]);
  // eslint-disable-next-line react-hooks/exhaustive-deps
  var enqueueSnackbar = useCallback(function (message, options) {
    if (options === void 0) {
...
var SnackbarProvider = /*#__PURE__*/memo(Provider);
...
export { DEFAULT_OPTIONS, OPPOSITE_DIRECTIONS, SnackbarDefaults, SnackbarProvider, enqueueSnackbar, useSnackbar };
//# sourceMappingURL=react-snackbars-stack.esm.js.map
